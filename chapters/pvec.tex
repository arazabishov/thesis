...
\todo{Introduce what is crate / cargo in the Rust introduction}

\chapter{Persistent vectors in Rust}
\label{chapter:persistent-vectors-in-rust}

%  - Where to find documentation, crates, etc.
% A link to the library source code, documentation, and the web application for visualization can be found at: \url{https://abishov.com/pvec-rs}.
