...
\begin{itemize}
    ...
    \item \crate{benches-mem}: The benchmarking application for measuring the memory footprint of persistent vectors. Its usage is described in detail in Chapter \ref{chapter:methodology}.
\end{itemize}

The structure of the library is demonstrated in Listing \ref{lst:library-structure}. The \dir{pvec-rs} directory is the root of the library crate. The definition of \rrbtree{}, \rbvec{}, \rrbvec{}, and \pvec{} are all located under the \dir{src} folder. The \dir{benches} and \dir{tests} folders are for runtime benchmarks and integration tests correspondingly.
...
\begin{table}[!ht]
    ...
    \begin{tabular} { p{98mm} p{8mm} p{8mm} p{8mm} }
        ...
        \textbf{A vector function} & \rotatebox{64}{\stdvec{}} & \rotatebox{64}{\rbvec{}} & \rotatebox{64}{\rrbvec{}} \\ \hline

        \rust{fn push(&mut self, e: T)} & \multirow{2}{*}{\bigo{1}} & \multirow{2}{*}{\bigo{1}}  & \multirow{2}{*}{\bigo{1}} \\
        Appends an element to the back of a collection & & & \\ \hdashline

        \rust{fn pop(&mut self) -> Option<T>} & \multirow{2}{*}{\bigo{1}} & \multirow{2}{*}{\bigo{1}}  & \multirow{2}{*}{\bigo{1}} \\
        Returns the last removed value or \rust{None} if vector is empty. & & & \\ \hdashline

        \rust{fn get(&self, i: usize) -> Option<&T>} & \multirow{2}{*}{\bigo{1}} & \multirow{2}{*}{\bigo{1}}  & \multirow{2}{*}{\bigo{1}} \\
        Returns a reference to an element. & & & \\ \hdashline

        \rust{fn get_mut(&mut self, i: usize) -> Option<&mut T>} & \multirow{2}{*}{\bigo{1}} & \multirow{2}{*}{\bigo{1}}  & \multirow{2}{*}{\bigo{1}} \\
        Returns a mutable reference to an element. & & & \\ \hdashline

        \rust{fn append(&mut self, v: &mut Vec<T>)} & \multirow{2}{*}{\bigo{1}} & \multirow{2}{*}{\bigo{1}}  & \multirow{2}{*}{\bigo{1}} \\
        Moves all values of \rust{v} into \rust{self}, leaving other empty. & & & \\ \hdashline

        \rust{fn len(&self) -> usize} & \multirow{2}{*}{\bigo{1}} & \multirow{2}{*}{\bigo{1}}  & \multirow{2}{*}{\bigo{1}} \\
        Returns the number of elements in the vector. & & & \\ \hdashline

        \rust{fn is_empty(&self) -> bool} & \multirow{2}{*}{\bigo{1}} & \multirow{2}{*}{\bigo{1}}  & \multirow{2}{*}{\bigo{1}} \\
        Returns \rust{true} if the vector contains no elements. & & & \\ \hdashline

        \rust{fn split_off(&mut self, at: usize) -> Vec<T>} & \multirow{2}{*}{\bigo{1}} & \multirow{2}{*}{\bigo{1}}  & \multirow{2}{*}{\bigo{1}} \\
        Splits the collection into two at the given index. & & & \\ \hdashline

        \rust{fn into_iter(self) -> Iterator} & \multirow{2}{*}{\bigo{1}} & \multirow{2}{*}{\bigo{1}}  & \multirow{2}{*}{\bigo{1}} \\
        Creates an iterator from \rust{self}. & & & \\ \hdashline

        \rust{fn into_par_iter(self) -> IntoParallelIterator} & \multirow{2}{*}{\bigo{1}} & \multirow{2}{*}{\bigo{1}}  & \multirow{2}{*}{\bigo{1}} \\
...
% * The web-vis crate and serde-serializer flag.
% * Wasmpack for compiling Rust to WebAssembly.
% * Using JS + D3 to visualize the implementation.
...
As demonstrated in \rust{mutable_api} in Listing \ref{lst:conventional-interface}, the conventional interface allows to update the vector in-place without creating copies.
