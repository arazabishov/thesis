...
\label{chapter:persistent-vector-in-rust}
...
\begin{itemize}
    \item The library crate with the persistent vector implementation.
    \item A binary application for measuring the memory footprint of the data structure.
    \item A web application for visualization of the data structure in the browser.
\end{itemize}

%  - Structure
    %  - Which modules and files does it consist of?
The folder structure of the library is demonstrated in listing \todo{ref}. A link to the library source code, as well as documentation, and the web application for visualization can be found at: \todo{href}.
...
%  - API
    %  - Which types does it expose?
    %  - Which methods / traits does it provide?
%  - How to build / compile / use the library?

\subsection{Configurability}


\subsection{Visualization}
%  - Which demos / features does it have?
