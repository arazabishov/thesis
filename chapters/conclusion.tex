...
The API surface of the \pvecrs{} does not expose the same set of methods as the standard vector does. Available methods are listed in \Cref{tab:vec-implementations}.
...
An annotated example of this optimization in use is provided in \Cref{fig:switching-to-flat}.
