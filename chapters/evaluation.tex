...
The setup routine prepares a collection of vectors, where each consecutive vector bigger than the previous. The total size of all prepared vectors adds up to the problem size. The benchmark is parameterized over the vector size, which will be in the [10, 1M] range. 
