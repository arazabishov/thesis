...
\begin{figure}
    ...
    \begin{tikzpicture}[
        ...
        \draw[|-|]([yshift=-3mm,xshift=1mm]array-1-1.south west) -- ([yshift=-3mm,xshift=-1mm]array-1-12.south east);

        \draw[|-|]([yshift=-6mm,xshift=1mm]array-1-1.south west) -- ([yshift=-6mm,xshift=-1mm]array-1-6.south east);
        \draw[|-|]([yshift=-6mm,xshift=1mm]array-1-7.south west) -- ([yshift=-6mm,xshift=-1mm]array-1-12.south east);

        \draw[|-|]([yshift=-9mm,xshift=1mm]array-1-1.south west) -- ([yshift=-9mm,xshift=-1mm]array-1-3.south east);
        \draw[|-|]([yshift=-9mm,xshift=1mm]array-1-4.south west) -- ([yshift=-9mm,xshift=-1mm]array-1-6.south east);
        \draw[loosely dotted]([yshift=-9mm,xshift=1mm]array-1-7.south west) -- ([yshift=-9mm,xshift=-1mm]array-1-12.south east);

        \draw[|-|]([yshift=-12mm,xshift=1mm]array-1-1.south west) -- ([yshift=-12mm,xshift=-1mm]array-1-2.south east);
        \draw[|-|]([yshift=-12mm,xshift=1mm]array-1-3.south west) -- ([yshift=-12mm,xshift=-1mm]array-1-3.south east);
        \draw[loosely dotted]([yshift=-12mm,xshift=1mm]array-1-4.south west) -- ([yshift=-12mm,xshift=-1mm]array-1-12.south east);

        \draw[|-|]([yshift=-15mm,xshift=1mm]array-1-1.south west) -- ([yshift=-15mm,xshift=-1mm]array-1-1.south east);
        \draw[|-|]([yshift=-15mm,xshift=1mm]array-1-2.south west) -- ([yshift=-15mm,xshift=-1mm]array-1-2.south east);
        \draw[loosely dotted]([yshift=-15mm,xshift=1mm]array-1-2.south west) -- ([yshift=-15mm,xshift=-1mm]array-1-12.south east);        
    \end{tikzpicture}
