...
% * assumption is that increase in threads used should improve perf
% * mention that resuls are presented in three dimensions, not two, because of thread count difference

\subsection{Incrementing each element of a vector.}
% * benefits of parallelism
%   * single thread performance
%   * correlation of perf improvements with thread count increase
% * rb vs rrb vector
%   * difference becomes more apparent for large values
...
\begin{figure}[t]    
    ...
    \begin{tikzpicture} 
        ...
        \begin{loglogaxis}[         
            ...
            \addplot3[surf, mesh/rows=5, opacity=0.1, fill opacity=0.3, color=mred] table [x={size}, y={threads}, z={time}, col sep=comma] {chapters/data/map_fold/std-vec.csv}; 
            \addlegendentry{Vec}

            \addplot3[surf, mesh/rows=5, opacity=0.1, fill opacity=0.3, color=morange] table [x={size}, y={threads}, z={time}, col sep=comma] {chapters/data/map_fold/rrbvec-balanced.csv}; 
            \addlegendentry{RbVec}

            \addplot3[surf, mesh/rows=5, opacity=0.1, fill opacity=0.3, color=blue] table [x={size}, y={threads}, z={time}, col sep=comma] {chapters/data/map_fold/rrbvec-unbalanced.csv}; 
            \addlegendentry{RrbVec}

            \addplot3[surf, mesh/rows=5, opacity=0.1, fill opacity=0.3, color=mgreen] table [x={size}, y={threads}, z={time}, col sep=comma] {chapters/data/map_fold/pvec-unbalanced.csv}; 
            \addlegendentry{PVec}
        \end{loglogaxis}     
    \end{tikzpicture} 
...
\begin{figure}[t]    
    ...
    \begin{tikzpicture}         
        ...
        \begin{loglogaxis}[         
            ...
            width=320pt,            
            title style={align=center},
            title={Time comparison of filtering out odd numbers of the N sized vector\\ parallelised on K number of threads.},
            ymajorgrids=true, 
            xmajorgrids=true,
            zmajorgrids=true,
            xlabel={vector size (log scale)},
            ...
            \addplot3[surf, mesh/rows=5, opacity=0.1, fill opacity=0.3, color=mred] table [x={size}, y={threads}, z={time}, col sep=comma] {chapters/data/filter_fold/std-vec.csv}; 
            \addlegendentry{Vec}

            \addplot3[surf, mesh/rows=5, opacity=0.1, fill opacity=0.3, color=morange] table [x={size}, y={threads}, z={time}, col sep=comma] {chapters/data/filter_fold/rrbvec-balanced.csv}; 
            \addlegendentry{RbVec}

            \addplot3[surf, mesh/rows=5, opacity=0.1, fill opacity=0.3, color=blue] table [x={size}, y={threads}, z={time}, col sep=comma] {chapters/data/filter_fold/rrbvec-unbalanced.csv}; 
            \addlegendentry{RrbVec}

            \addplot3[surf, mesh/rows=5, opacity=0.1, fill opacity=0.3, color=mgreen] table [x={size}, y={threads}, z={time}, col sep=comma] {chapters/data/filter_fold/pvec-unbalanced.csv}; 
            \addlegendentry{PVec}
        \end{loglogaxis}     
    \end{tikzpicture} 

    \label{fig:filter-fold}
    \caption{Filtering out odd numbers of a vector on multiple threads.}    
\end{figure}

\subsection{Filtering out odd integers.}
% * benefits of parallelism
%   * single thread performance
%   * correlation of perf improvements with thread count increase
% * rb vs rrb vector
