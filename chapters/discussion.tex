...
\paragraph{Balanced vs unbalanced} As shown in \ref{fig:push-existing}, the difference in performance between balanced and unbalanced variants is negligible, mostly because pushing new values creates balanced nodes. 
...
\stdvec{} showed the best results in \ref{fig:push-existing} test. It was TODOX faster on average in comparison to the fastest runner up, balanced \rrbvec{}. \imrsvec{} was marginally slower by TODOX in comparison to \pvec{}. 
