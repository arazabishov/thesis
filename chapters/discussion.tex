...
% Dynamic representation showed improvements over RRB-Tree based vector implementation in most tests. The exceptions are tests that involved mutation and clone operation, and only up to the threshold value after which pvec switches from vec to rrbvec. Parallel vector implementation showed good results as well. 

Dynamic representation improved performance of \pvec{} over \rrbvec{} in the majority of benchmarks, with the exception of tests using clone. It has improved performance of operations such as push, pop, index, concatenation, and slicing for the small sized vectors.
