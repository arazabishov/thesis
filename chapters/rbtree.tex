...
If \m{} is equal to 4, the maximum subkey value will be 3, which equals to 00000011\textsubscript{2}.

\begin{figure}        
    \caption{Visualization of radix search.}
...
The height of the tree in \Cref{fig:rb-tree-example-1} is 4. The goal is to lookup the contents of an element corresponding to the key 104, which is equal to 01101000\textsubscript{2}. \Cref{lst:rb-tree-radix-search} outlines the radix search algorithm implementation. 
